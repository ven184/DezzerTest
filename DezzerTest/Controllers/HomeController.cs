        ...
        public IActionResult Result(List<string> answers)
        {
            ...
            switch (result)
            {
                case "Милена / Иерархия":
                    description = @"Сочетает независимость мышления с сильным внутренним стержнем. Она не стремится привлекать внимание, предпочитая наблюдать, анализировать и принимать собственные решения. Ей близки свобода, развитие и искренность, а поверхностность быстро теряет для нее интерес. Если Милена выбирает цель, она идет к ней уверенно, сохраняя спокойствие и верность своим принципам. Она умеет видеть возможности там, где другие замечают лишь препятствия, и вдохновляет окружающих оставаться собой.";
                    break;

                case "Ася / Катарсис":
                    description = @"Самый настоящий стратег, который всегда думает на несколько шагов вперед. Она любит сложные идеи, необычные темы и легко превращает хаос в четкий план действий. Со стороны может показаться спокойной, но внутри постоянно работает поток мыслей, концепций и новых проектов. Она ценит знания, умеет видеть закономерности и редко оставляет что-либо на волю случая. Если за что-то берется она, можно быть уверенным: все будет продумано до мелочей.";
                    break;

                case "Зуля / Zxeg":
                    description = @"Сочетает в себе творческое мышление и любовь к поиску глубоких смыслов даже в самых обычных вещах. Она легко замечает красоту там, где другие проходят мимо, а еe решения чаще основаны на интуиции, чем на строгой логике. При этом она умеет признавать ошибки и стремится сделать окружающий мир хоть немного лучше. Ее идеи часто рождаются поздно ночью, когда начинаются самые интересные разговоры. Она человек, который помогает другим не потерять направление, оставаясь верным себе.";
                    break;

                case "Мира / Effórt":
                    description = @"Легко становится человеком, рядом с которым хочется остаться подольше. Она умеет поддержать разговор практически на любую тему, внимательно слушает людей и хорошо чувствует их настроение. При этом в ней есть легкая загадочность: иногда она неожиданно исчезает, словно ей необходимо время побыть наедине с собой. Она тонко понимает человеческие эмоции и умеет видеть в людях больше, чем они показывают окружающим. Благодаря этому общение с ней всегда остаётся теплым и запоминающимся.";
                    break;

                case "Хэс / Эремиция":
                    description = @"Кажется тихим и спокойным человеком, но именно такие люди чаще всего оказываются самыми надежными. Она не любит привлекать к себе внимание и предпочитает сначала внимательно изучить ситуацию, прежде чем действовать. В ней сочетаются мягкость, искренность и внутренняя стойкость, которая становится заметной только со временем. Она ценит глубокие связи, комфортную атмосферу и умеет сохранять самообладание даже тогда, когда вокруг становится шумно. Именно это делает ее человеком, которому легко доверять.";
                    break;

                case "Динара / Diletant":
                    description = @"Человек с живым воображением, которое постоянно подбрасывает новые идеи, сюжеты и неожиданные повороты. Ее тянет ко всему необычному, мрачному и эмоционально насыщенному, поэтому скучные истории точно не про нее. За любовью к черному юмору и безумию скрывается богатая фантазия и желание исследовать самые разные стороны человеческой природы. Она легко превращает обычную ситуацию в целую историю, которую будут обсуждать еще долго. Именно благодаря этой способности ее идеи всегда выделяются и редко кого оставляют равнодушным.";
                    break;
            }
